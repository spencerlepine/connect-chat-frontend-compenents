...
export const RICH_TOOLBAR_EMOJI_BUTTON_ID = `richToolbarButton_${
  inlineFormatDisplayOrder.length + blockTypeDisplayOrder.length + linkFormatDisplayOrder.length
}`;
